    ...
    <div className="absolute inset-0 overflow-hidden pointer-events-none">
      {isDark ? (
        <>
          ...
          <div
            className="absolute inset-x-0 bottom-0 top-22 bg-cover bg-top bg-no-repeat opacity-90"
        ...
        <>
          ...
          <div
            className="absolute inset-x-0 bottom-0 top-22 bg-cover bg-top bg-no-repeat"
