export function StructuredData() {
  const organizationSchema = {
    ...
    description:
      "Professional security cameras installer in Abbottabad, Islamabad, Lahore and across Pakistan. Premium Security & Surveillance (CCTV), Networking Solutions, Access Control, and digital systems.",
    address: {
      "@type": "PostalAddress",
      addressCountry: "PK",
  ...
  const localBusinessSchema = {
    ...
    description:
      "Leading security cameras installer in Abbottabad and provider of Security & Surveillance (CCTV), Networking Solutions, Access Control, and digital systems across Pakistan",
    url: "https://upedgetechnologies.shop",
    priceRange: "$$",
    address: {
      "@type": "PostalAddress",
