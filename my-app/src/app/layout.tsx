...
export const metadata: Metadata = {
  ...
  description:
    "UpEdge Technologies provides premium Security & Surveillance (CCTV), Networking Solutions, Access Control, and digital systems across Pakistan. Professional security cameras installer in Abbottabad, Islamabad, Lahore, Rawalpindi, Karachi & major cities. Expert installation, maintenance, and support for homes and businesses.",
  keywords: [
    "UpEdge Technologies",
    "upedgetechnologies",
  ...
  openGraph: {
    ...
    description:
      "Premium Security & Surveillance (CCTV), Networking Solutions, Access Control, and digital systems in Pakistan. Expert installation, maintenance, and support.",
    images: [
      {
        url: "/upedge.png",
        width: 1200,
  ...
  twitter: {
    ...
    description:
      "Premium Security & Surveillance (CCTV), Networking Solutions, Access Control, and digital systems in Pakistan.",
    images: ["/upedge.png"],
    creator: "@upedgetech",
  },
  icons: {
